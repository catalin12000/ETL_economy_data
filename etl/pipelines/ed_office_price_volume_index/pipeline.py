...
class Pipeline:
    ...
    # Permalinks found on the BoG real estate page
    ...
    def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not price_changed and not rent_changed:
            return {"status": "skipped", "message": "Both Office PDFs are unchanged.", "state": new_state}
        ...
        return {
            "status": "delivered", 
            "message": f"Downloaded updated Office PDF(s): {', '.join(changed)}", 
            "state": new_state
        }
