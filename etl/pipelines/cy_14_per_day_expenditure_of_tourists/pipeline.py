...
class Pipeline:
    ...
    def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        query = {
            "query": [
                {
                    "code": "EXPENDITURE, LENGTH OF STAY, ARRIVALS",
                    "selection": {
                        "filter": "item",
                        "values": ["3"]  # Expenditure - Per Day (€)
                    }
                },
                {
                    ...
                    "selection": {
                        "filter": "item",
                        "values": [str(i) for i in range(21)]  # All 21 countries including Total
                    }
                }
            ],
            "response": {
        ...
        print(f"Requesting Tourist Expenditure data from CYSTAT API...")
