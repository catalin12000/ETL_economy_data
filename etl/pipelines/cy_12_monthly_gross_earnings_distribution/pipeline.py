...
class Pipeline:
    ...
    def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
            ...
            "query": [
                {
                    ...
                    "selection": {
                        "filter": "item",
                        "values": ["0", "1", "2"]  # Total, Males, Females
                    }
                },
                {
                    "code": "GROSS MONTHLY EARNINGS (€)",
                    "selection": {
                        "filter": "item",
                        "values": [str(i) for i in range(25)]  # All 25 bands including Total
                    }
                }
            ],
            "response": {
        ...
        print(f"Requesting Earnings Distribution data from CYSTAT API...")
