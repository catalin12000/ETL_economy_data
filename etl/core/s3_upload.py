...
def _s3_key(
    ...
    """Build S3 key: {folder}/{country}/economy_data/{source}/{YYYYMMDD}/{stem}_{timestamp}.{ext}"""
    ...
    return f"{folder}/{country}/economy_data/{source}/{date_folder}/{stem}_{timestamp}{ext}"
