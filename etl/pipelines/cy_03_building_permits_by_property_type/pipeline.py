...
class Pipeline:
    ...
    def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        out_path = out_dir / "cystat_building_permits_type.csv"
            ...
            "query": [
                {
                    ...
                    "selection": {
                        "filter": "item",
                        "values": [str(i) for i in range(26)]  # All 26 project types
                    }
                },
                {
                    "code": "MEASUREMENT",
                ...
                },
                {
                    ...
                    "selection": {
                        "filter": "item",
                        "values": ["0", "1", "2", "3"]  # Permits, Area, Value, Units
                    }
                }
            ],
            "response": {
        ...
        print(f"Requesting Building Permits Type data from CYSTAT API...")
