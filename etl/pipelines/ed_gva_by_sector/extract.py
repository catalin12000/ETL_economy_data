...
NACE_TO_DB_COL: dict[str, str] = {
    # ELSTAT uses plain division numbers in col 0 (e.g. "10-12", "41-43")
    "1":     "crop_animal_prod_hunting_svc",
    "2":     "forestry_logging",
    "3":     "fishing_aquaculture",
    "5-9":   "mining_quarrying",
    "10-12": "manufacture_food_beverages",
    "13-15": "manufacture_textiles_apparel",
    "16":    "manufacture_wood_products",
    "17":    "manufacture_paper_products",
    "18":    "printing_reproduction_media",
    "19":    "manufacture_coke_petroleum",
    "20":    "manufacture_chemicals",
    "21":    "manufacture_pharmaceuticals",
    "22":    "manufacture_rubber_plastic",
    "23":    "manufacture_non_metallic_products",
    "24":    "manufacture_basic_metals",
    "25":    "manufacture_metal_products",
    "26":    "manufacture_computer_optical_products",
    "27":    "manufacture_electrical_equipment",
    "28":    "manufacture_machinery",
    "29":    "manufacture_vehicles",
    "30":    "manufacture_transport_equip",
    "31-32": "manufacture_furniture",
    "33":    "repair_install_machinery_equip",
    "35":    "electric_gas_steam_supply",
    "36":    "water_collection_treatment",
    "37-39": "sewerage_waste_management",
    "41-43": "construction",
    "45":    "wholesale_retail_motor_vehicles",
    "46":    "wholesale_trade_non_motor_vehicles",
    "47":    "retail_trade_non_motor_vehicles",
    "49":    "land_transport_pipeline_transport",
    "50":    "water_transport",
    "51":    "air_transport",
    "52":    "warehousing_transport_support",
    "53":    "postal_courier_activities",
    "55-56": "accommodation_food_beverage_svc",
    "58":    "publishing_activities",
    "59-60": "motion_picture_broadcasting",
    "61":    "telecommunications",
    "62-63": "computer_programming_consultancy",
    "64":    "financial_svc_ex_insurance",
    "65":    "insurance_pension_funding",
    "66":    "aux_financial_insurance_svc",
    "68":    "real_estate_activities",
    "69-70": "legal_accounting_consultancy_svc",
    "71":    "arch_eng_technical_testing",
    "72":    "scientific_research_development",
    "73":    "advertising_market_research",
    "74-75": "professional_scientific_tech_svc",
    "77":    "rental_leasing_activities",
    "78":    "employment_activities",
    "79":    "travel_agency_tour_operator",
    "80-82": "security_investigation_services",
    "84":    "public_admin_defence",
    "85":    "education",
    "86":    "human_health_activities",
    "87-88": "social_work_activities",
    "90-92": "creative_arts_cultural_activities",
    "93":    "sports_recreation_activities",
    "94":    "org_membership_activities",
    "95":    "repair_computers_personal_goods",
    "96":    "personal_service_activities",
    "97-98": "household_employers_private_household_svc",
    "99":    "extraterritorial_org_activities",
    "B.1*G": "gdp",
    "D.21-D.31": "taxes_less_subsidies",
    # NACE letter-code variants (fallback)
...
def extract_gva(xls_path: Path) -> pd.DataFrame:
    ...
    if unmapped:
        safe = [c.encode("ascii", "replace").decode() for c in sorted(unmapped)]
        print(f"  [ed_gva_by_sector] unmapped NACE codes (add to NACE_TO_DB_COL): {safe}")
