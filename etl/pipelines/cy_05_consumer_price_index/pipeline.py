...
class Pipeline:
    ...
    API_URL = "https://cystatdb.cystat.gov.cy/api/v1/en/8.CYSTAT-DB/Price%20Indices/Consumer%20Price%20Index/0410010E.px"
    ...
    def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        out_path = out_dir / "cystat_cpi.csv"

        # PxWeb API Query
        query = {
            "query": [
                {
                    "code": "GATEGORIES OF GOODS AND SERVICES",
                    "selection": {
                        "filter": "item",
                        "values": ["12"]  # General Consumer Price Index
                    }
                },
                {
                    "code": "INDICATOR",
