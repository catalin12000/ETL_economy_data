...
def extract_retail_trade_turnover(path: Path) -> pd.DataFrame:
    ...
    for i in range(12, len(df)):
        ...
        values = {
            ...
            "retail_sale_outside_stores_index": _parse_float(df.iat[i, 13]),
        }
    ...
    if out.empty:
        raise RuntimeError("No rows extracted from TABLE 1 in retail trade turnover workbook.")
