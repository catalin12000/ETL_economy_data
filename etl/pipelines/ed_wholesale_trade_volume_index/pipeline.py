...
class Pipeline:
    pipeline_id = "ed_wholesale_trade_volume_index"
    display_name = "Wholesale Trade Volume Index"

    PUBLICATION_CODE = "DKT42"
    TARGET_TITLE_SUBSTRING = "04. Volume Index in Wholesale Trade"

    def run(self, state: Dict[str, Any]) -> Dict[str, Any]:
        out_dir = Path("data/downloads") / f"44_{self.pipeline_id}"
        out_dir.mkdir(parents=True, exist_ok=True)

        out_path = out_dir / "elstat_wholesale_volume.xls"
